...
public class DepartmentProcRepository {
	...
	public DepartmentProcRepository(JdbcTemplate jdbcTemplate) {
	...
	public Page<Department> findAll(Pageable pageable) {
		...
		String sql = "select * from department_list_by_page(" + pageSize + ", " + offset + ")";
	...
	public void deleteById(String id) {
		String sql = "call delete_department ('" + id + "')";
	...
	public void save(Department department) {
		...
		String sql = String.format("call insert_department('%s', '%d', '%s')", abbr, facultyId, name);
		jdbcTemplate.execute(sql);
	}

	public Department findById(String id) {
		String sql = "select * from department_find_by_id('" + id + "')";
