...
import com.kvs.universityapplication.dao.StudentProcRepository;
import com.kvs.universityapplication.entity.Student;

@Service
public class StudentServiceImpl implements StudentService {

	private StudentProcRepository studentRepository;

	public StudentServiceImpl(StudentProcRepository studentRepository) {
