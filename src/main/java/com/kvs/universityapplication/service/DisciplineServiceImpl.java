...
import com.kvs.universityapplication.dao.DisciplineSqlRepository;
import com.kvs.universityapplication.entity.Discipline;

@Service
public class DisciplineServiceImpl implements DisciplineService {

	private DisciplineSqlRepository disciplineRepository;
	private final int PAGE_SIZE = 10;

	public DisciplineServiceImpl(DisciplineSqlRepository disciplineRepository) {
