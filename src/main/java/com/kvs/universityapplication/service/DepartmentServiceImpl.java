...
import com.kvs.universityapplication.dao.DepartmentProcRepository;
import com.kvs.universityapplication.entity.Department;

@Service
public class DepartmentServiceImpl implements DepartmentService {

	private DepartmentProcRepository departmentRepository;
	private final int PAGE_SIZE = 10;

	public DepartmentServiceImpl(DepartmentProcRepository departmentRepository) {
